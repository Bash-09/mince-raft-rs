        ...
        ScrollArea::vertical().show(ui, |ui| {
            ...
            ui.collapsing("Camera", |ui| {
                ui.horizontal(|ui| {
                    ...
                    if ui.add(egui::Slider::new(&mut fov, RangeInclusive::new(60.0, 120.0))).changed() {
            ...
            ui.collapsing("Input", |ui| {
                ui.horizontal(|ui| {
                    ...
                    ui.add(egui::Slider::new(&mut settings.mouse_sensitivity, RangeInclusive::new(0.1, 10.0)));
                }); 
            });
