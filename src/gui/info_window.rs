    ...
    egui::Window::new("Info")
        .show(gui_ctx, |ui| {
            ...
            ui.horizontal(|ui| {
                ...
                ui.label(RichText::new(format!("{}", server.get_network_destination())).color(Color32::LIGHT_GRAY));
            });
            ...
            ui.horizontal(|ui| {
                ...
                ui.label(RichText::new(format!("{:?} {}", server.get_difficulty(), difficulty_locked)).color(Color32::LIGHT_GRAY));
            });
            ...
            ui.horizontal(|ui| {
                ...
                ui.label(RichText::new(format!("{}", server.get_world_time() / 24000)).color(Color32::LIGHT_GRAY));
            });
            ...
            ui.horizontal(|ui| {
                ui.vertical(|ui| {
                    ...
                    ui.label(egui::RichText::new(format!("{:.2}", server.get_player().health)).color(Color32::LIGHT_GRAY));
                });

                ui.vertical(|ui| {
                    ui.label(egui::RichText::new("Food"));
                    ui.label(egui::RichText::new(format!("{:.2}", server.get_player().food)).color(Color32::LIGHT_GRAY));
                });

                ui.vertical(|ui| {
                    ui.label(egui::RichText::new("Saturation"));
                    ui.label(egui::RichText::new(format!("{:.2}", server.get_player().saturation)).color(Color32::LIGHT_GRAY));
                });
            });
